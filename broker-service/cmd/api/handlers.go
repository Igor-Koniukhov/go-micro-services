...
func (app *Config) HandleSubmission(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Println(requestPayload, " request info")
...
func (app *Config) authenticate(w http.ResponseWriter, a AuthPayload) {
	...
	// call the service authentication-service
	request, err := http.NewRequest(
		"POST",
		fmt.Sprintf("http://authentication-service:%v/authenticate", webPort),
...
func (app *Config) sendMail(w http.ResponseWriter, msg MailPayload) {
	...
	mailServiceURL := fmt.Sprintf("http://mail-service:%v/send", webPort)
	...
	var payload jsonResponse
	payload.Error = false
	payload.Message = "Sent to " + msg.To
